...
if __name__ == '__main__':
    ...
    DLMESO = Meso('DL', Micro('DL', MAX=PLP.DLMAX, DYN=PLP.DLDYN))
    BPMESO = Meso('BP', Micro('BP', MAX=PLP.BPMAX, DYN=PLP.BPDYN))
    SQMESO = Meso('SQ', Micro('SQ', MAX=PLP.SQMAX, DYN=PLP.SQDYN))
